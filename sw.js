const CACHE='cuenta-clara-v20';
const ASSETS=['./','./index.html','./manifest.webmanifest','./cuenta-clara-logo-v20-180.png','./cuenta-clara-logo-v20-192.png','./cuenta-clara-logo-v20-512.png'];
