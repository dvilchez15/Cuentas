const CACHE='cuenta-clara-v21';
const ASSETS=['./','./index.html','./manifest.webmanifest','./cuenta-clara-logo-v21-180.png','./cuenta-clara-logo-v21-192.png','./cuenta-clara-logo-v21-512.png'];
