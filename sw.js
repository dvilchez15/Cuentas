const CACHE='cuenta-clara-v18';
const ASSETS=['./','./index.html','./manifest.webmanifest','./cuenta-clara-logo-v18-180.png','./cuenta-clara-logo-v18-192.png','./cuenta-clara-logo-v18-512.png'];
